...
const base =
  "inline-flex h-[var(--button-height)] w-full items-center justify-center rounded-[var(--radius-button)] px-6 text-[var(--text-sm)] font-[var(--weight-semibold)] tracking-[var(--tracking-snug)] transition-all duration-150 focus-visible:outline-none focus-visible:shadow-[var(--focus-ring)] disabled:cursor-not-allowed disabled:opacity-50";
